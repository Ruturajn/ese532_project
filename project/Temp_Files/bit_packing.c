    ...
    for (int i = 0; i < LZW_CODES_LEN; i++) {
        ...
        if (bits_left == 0 && current_val_bits_left == 5) {
            if (data_idx < data_len) {
                data[data_idx] = (current_val & 0x1F);
                bits_left = 3;
        ...
        if (bits_left == 3 && current_val_bits_left == CODE_LENGTH) {
            data[data_idx] = ((data[data_idx] << 3) | (((current_val >> 10)) & 0x07));
            bits_left = 0;
            data_idx += 1;
        ...
        if (bits_left == 0 && current_val_bits_left == 2) {
            if (data_idx < data_len) {
                data[data_idx] = (current_val & 0x03);
                bits_left = 6;
                current_val_bits_left = 0;
                continue;
            } else
        ...
        if (bits_left == 6 && current_val_bits_left == CODE_LENGTH) {
            data[data_idx] = ((data[data_idx] << 6) | (((current_val >> 7)) & 0x3F));
            bits_left = 0;
            data_idx += 1;
        ...
        if (bits_left == 0 && current_val_bits_left == 7) {
            if (data_idx < data_len) {
                data[data_idx] = (current_val & 0x7F);
                bits_left = 1;
                current_val_bits_left = 0;
                continue;
            } else
        ...
        if (bits_left == 1 && current_val_bits_left == CODE_LENGTH) {
            data[data_idx] = ((data[data_idx] << 1) | ((current_val >> 12) & 0x1));
            bits_left = 0;
            data_idx += 1;
        ...
        if (bits_left == 0 && current_val_bits_left == 4) {
            if (data_idx < data_len) {
                data[data_idx] = (current_val & 0x0F);
                bits_left = 4;
                current_val_bits_left = 0;
                continue;
            } else
        ...
        if (bits_left == 4 && current_val_bits_left == CODE_LENGTH) {
            data[data_idx] = ((data[data_idx] << 4) | ((current_val >> 9) & 0x0F));
            data_idx += 1;
            bits_left = 0;
        ...
        if (bits_left == 0 && current_val_bits_left == 1) {
            data[data_idx] = ((data[data_idx] << 1) | (current_val & 0x01));
            bits_left = 7;
            current_val_bits_left = 0;
            continue;
        }
        ...
        if (bits_left == 7 && current_val_bits_left == CODE_LENGTH) {
            data[data_idx] = ((data[data_idx] << 7) | ((current_val >> 6) & 0x7F));
            bits_left = 0;
